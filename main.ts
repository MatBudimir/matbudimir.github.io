namespace Portfolio {
    ...
    function load() {
        ...
        about.id = "descr";
        about.innerText = "Game Designer with a background in visual arts, on a journey to create engaging games and meaningful experiences. Currently making games 900 meters above sea level.\n\nAlways aiming for the stars.";
    ...
    // 6) Dead Man's Call
    // 7) SymphoTea
    function createGameInfo(vid1: HTMLElement, vid2: HTMLElement, vid3: HTMLElement, vid4: HTMLElement, vid5: HTMLElement, vid6: HTMLElement, vid7: HTMLElement) {

        // Game 1: ...
        let game1Objects: Portfolio.TimelineObj[] = [
            new Portfolio.TimelineObj("Text", "Denise Franz\nFlorine Bienhüls\nJannick Klose\nMatej Budimir", "", true, false, false, false, "Game Design, Programming, Music\nUI/UX Design\nGame Design, Programming\nGame Design, Programming, Art, Project Management"),
            new Portfolio.TimelineObj("Text", "· Designed and pitched the core game concept based on dice based combat and collecting demons\n· Discussed and worked out in-depth mechanics for the combat, focusing on strategy and varience\n· Created paper prototypes and playtested multiple versions of the combat system (as team), updating the game based on user feedback\n· Implemented gameplay features using C# and Unity, including combat algorithms, adaptive UI elements, game sounds, and character prefabs\n· Designed and illustrated characters and UI elements for the combat scene\n· Planned and organized tasks in an agile environment to reach our goals\n· Assisted other team members by becoming an expert in basic Unity features and sharing the knowledge", "", false, true),
            new Portfolio.TimelineObj("Text", "Diceonomicon is a turn-based roguelike game with a focus on dicebuilding. To progress the players have to collect demon companions called Implings to fight for them, which they command using their bag of dice. The game takes place in a fantastical vibrant hell, inspired by ragtime, jazz and prohibition era America. Can you resist all the temptations along your the way out of hell?", ""),
        ...
        let game2Objects: Portfolio.TimelineObj[] = [
            new Portfolio.TimelineObj("Text", "Jannick Klose\nMatej Budimir\nYasmin Zahrir", "", true, false, false, false, "Programming, Accessibility (Gameplay), Sound\nGame Design, Level Design, Programming, Sound\nProgramming, Accessibility (Menu/Settings)"),
            new Portfolio.TimelineObj("Text", "· Designed and pitched the core game concept, focusing on audio-based game mechanics\n· Designed and implemented the level layout using a modular room system to imrpove workflow\n· Created simple 3D assets in Blender: Spike blocks and floor spikes\n· Implemented core gameplay functions and interactions using Unreal Engine 5's Blueprints, including puzzles and a boss combat encounter\n· Created sounds with Ableton Live and implemented them using FMOD", "", false, true, false),
        ...
        // Fall of Egypt (2025)
        let game3Objects: Portfolio.TimelineObj[] = [
            ...
            new Portfolio.TimelineObj("Text", "· Designed the key game mechanics and play patterns, focusing on the player experience of city building and zombie survival, including player game actions, building effects and upgrades, resources and economy, player factions and their abilities, infection and zombie mechanics, and replayable game scenarios with engaging victory mechanics\n· Lead group meetings to discuss game design problems and questions\n· Planned and assigned tasks in an agile environment to reach our sprint goals\n· Painted the box art and game board illustrations\n· Designed and engraved wooden game tokens\n· Assisted other members in their 2D and 3D art related tasks\n· Wrote the narrative outline for the setting, as well as the descriptions for event cards\n· Programmed simulations for the game to collect data which can run thousands of games in a matter of seconds", "", false, true, false),
        ...
        let game5Objects: Portfolio.TimelineObj[] = [
        ...
        let game7Objects: Portfolio.TimelineObj[] = [
