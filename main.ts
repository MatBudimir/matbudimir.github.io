namespace Portfolio {
    ...
    function createGameInfo(vid1: HTMLElement, vid2: HTMLElement, vid3: HTMLElement, vid4: HTMLElement, vid5: HTMLElement, vid6: HTMLElement, vid7: HTMLElement) {
        ...
        let game5Objects: Portfolio.TimelineObj[] = [
            new Portfolio.TimelineObj("Text", "Christian Friedrich Bauer\nFlorine Bienhüls\nJustin Frei\nMatej Budimir\nMikhail Ko", "", true, false, false),
            new Portfolio.TimelineObj("Text", "· Designed a general layout for the spaceship, starting with a rough blockout, which allowed for modular use of it's room\n· I kitbashed 3D assets provided to us to create an environment fitting our narrative needs\n· Drew concept art for the spaceship enterior to find what kind of atmosphere we want the environment to have\n· Worked on several functions including: Button inputs and UI displays, FMOD and Sound implementation\n· Composed an atmospheric ambient sound\n· Created and mixed various sounds part of the game, including: doors, pickups, and footsteps", "", false, true, false),
